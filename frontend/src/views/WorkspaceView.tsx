...
export const WorkspaceView = () => {
  ...
  return (
    ...
    >
      {/* Dynamic Header */}
      <PanelHeader title={headerTitle} subtitle={headerSubtitle} />
          ...
          {!isChatActive ? (
            ...
            >
              ...
              <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
                ...
                <div className="absolute top-[22%] left-[50%] -translate-x-1/2 w-[280px] h-[280px] rounded-full bg-cyan-400/15 dark:bg-cyan-450/[0.055] blur-[60px] mix-blend-screen" />
              ...
              >
                ...
                <div className="flex flex-wrap items-center justify-center gap-3 mt-6 select-none">
                  <button
                    ...
                    className="px-4 py-2 border border-slate-200/80 dark:border-border-dark/80 bg-white/40 dark:bg-card-bg-dark/30 hover:border-slate-350 dark:hover:border-slate-800 hover:bg-slate-150/60 dark:hover:bg-slate-900/40 text-[11px] font-semibold text-slate-650 dark:text-slate-450 rounded-full transition-all duration-200 cursor-pointer shadow-sm hover:-translate-y-0.5 active:scale-[0.98]"
                  >
